...
// with bind delete function!!!
//deleteBtn.addEventListener('click', deleteMail.bind(null, element));
//sendEl.querySelector('.delete').addEventListener('click', deleteMail.bind(null, sendEl));
function solve2() {
    const recipientNameInput = document.getElementById('recipientName');
    const titleInput = document.getElementById('title');
    const messageInput = document.getElementById('message');
    ...
    function addEmail(event) {
        ...
        const deleteBtn = element.querySelector('#delete');
        deleteBtn.addEventListener('click', deleteMail.bind(null, element)); //двата начина са еквивалент
        // deleteBtn.addEventListener('click', () => deleteMail(element)); //това с горният запис
